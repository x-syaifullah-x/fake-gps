        ...
        intent?.apply {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                if (address is Resource.Success) {
                    ...
                    iHistoryRepo.insert(data.toHistoryModel(getStringExtra(HomeFragment.USER_ID_DATA_EXTRA)))
                    ...
                    Network.onConnected(
                        baseContext, MyWorker::class.java, Data.Builder()
                            ...
                            .putString(
                                HomeFragment.USER_ID_DATA_EXTRA,
                                getStringExtra(HomeFragment.USER_ID_DATA_EXTRA)
                            )
                            .build()
                    )
                }
